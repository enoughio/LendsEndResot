...
const Dining = () => {
  return (
    <section className="overflow-hidden px-[3vw] py-8 md:py-10 mx-auto">
      {/* Heading */}
      <div className="relative mb-8">
        ...
        <div className="md:hidden absolute -right-4 md:right-0  top-8 md:top-0 translate-y-[-40%] w-[20vw] md:w-[38vw] max-w-[220px] ">
          <Image
